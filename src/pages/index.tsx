...
const PokemonListing: React.FC<{
	...
	return (
		<div className="flex flex-col items-center">
			<Image src={props.pokemon.spriteUrl} alt={`https:raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${props.pokemon.id}.png`} width={256} height={256} />
